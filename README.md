# Hausdorff
## Main theorem
The set of scattered orders (those which do not contain a copy of the rationals) is equal to the smallest set of linear orders containing every singleton order and that is closed under well-ordered and reverse well-ordered lexicographic sums
...
Hausdorff.lean contains the main theorem.
